    ...
    <div className="navbar bg-base-100">
        <div className="navbar-start">
            ...
            <Link className="font-bold text-xl mx-[-4px]" to = '/'>
                <p className='flex gap-1'> <img src = '/hotelLogo.PNG' width={20}></img>Hotel <span className='text-blue-600'>booking</span></p>
            </Link>
        </div>
                ...
                <div> 
                {
                    ...
                    <div className={`dropdown dropdown-bottom dropdown-end ${isDropdownOpen ? 'open' : ''}`}>
                        ...
                        <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
                            ...
                            <li><Link to = {`/rented_hotels`} onClick={closeDropdown}>My Rented hotels</Link></li>
                            <li><Link to = {`/added_hotels`} onClick={closeDropdown}>My Added hotels</Link></li>
                        </ul>
                    </div>
                    :
